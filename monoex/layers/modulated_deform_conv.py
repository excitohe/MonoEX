...
class ModulatedDeformConv2dFunction(Function):
    ...
    def backward(ctx, grad_output):
        ...
        return (
            grad_input, grad_offset, grad_mask, grad_weight, grad_bias, None, None, None, None, None
        )
...
class ModulatedDeformConv2d(nn.Module):
    ...
    def forward(self, x, offset, mask):
        return modulated_deform_conv2d(
            x, offset, mask, self.weight, self.bias, self.stride, self.padding, self.dilation,
    ...
    def _load_from_state_dict(
        ...
        if version is None or version < 2:
            ...
            if (
                ...
                state_dict[prefix +
                           'conv_offset.weight'] = state_dict.pop(prefix[:-1] + '_offset.weight')
            if (

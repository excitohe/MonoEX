...
"""
    A torch process group which only includes processes that on the same
    machine as the current process. This variable is set when processes 
    are spawned by `launch()` in "engine/launch.py".
"""
...
def reduce_dict(input_dict, average=True):
    ...
    Args:
        input_dict (dict): inputs to be reduced. All the values must be 
            scalar CUDA Tensor.
